...
def home(request):
    ...
    return render(request,"RC/instructions.html",context)
...
def userLogin(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            return redirect("login")
    return render(request, 'RC/newlogin.html')
...
def questions(request):
    ...
    return render(request,"RC/quesHub.html",{"questions":questions,"player":user,"ques_list":ques_list, "end_time":var,"team_score":team.team_score})
...
def question(request,id):
    ...
    return render(request,"RC/rccoding.html",context)
...
def leaderboard(request):
    ...
    context["teams"]=dict
    return render(request,"RC/result.html",context)
